...
Also full list of models is available in dataframe using scparadise.scadam.available_models for scAdam models and scparadise.sceve.available_models for scEve models.
### scAdam models
